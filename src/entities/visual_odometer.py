...
class VisualOdometer(object):
    ...
    def __init__(self, intrinsics: np.ndarray, method_name="hybrid", device="cuda"):
        ...
        self.criteria_list = [
            ...
            o3d.t.pipelines.odometry.OdometryConvergenceCriteria(500),
            o3d.t.pipelines.odometry.OdometryConvergenceCriteria(500)]
        self.random_criteria_list=[
            o3d.t.pipelines.odometry.OdometryConvergenceCriteria(max_iteration=np.random.randint(50, 200)),
            o3d.t.pipelines.odometry.OdometryConvergenceCriteria(max_iteration=np.random.randint(50, 200)),
            o3d.t.pipelines.odometry.OdometryConvergenceCriteria(max_iteration=np.random.randint(50, 200))
        ]
    ...
    def estimate_rel_pose(self, image: np.ndarray, depth: np.ndarray, init_transform=np.eye(4)):
        ...
        # rel_transform1 = o3d.t.pipelines.odometry.rgbd_odometry_multi_scale(
        #     self.last_rgbd, rgbd, self.intrinsics, o3c.Tensor(init_transform),
        #     self.depth_scale, self.max_depth, self.random_criteria_list, self.method)
        # rel_transform2 = o3d.t.pipelines.odometry.rgbd_odometry_multi_scale(
        #     self.last_rgbd, rgbd, self.intrinsics, o3c.Tensor(init_transform),
        #     self.depth_scale, self.max_depth, self.random_criteria_list, self.method)
        # rel_transform3 = o3d.t.pipelines.odometry.rgbd_odometry_multi_scale(
        #     self.last_rgbd, rgbd, self.intrinsics, o3c.Tensor(init_transform),
        #     self.depth_scale, self.max_depth, self.random_criteria_list, self.method)
