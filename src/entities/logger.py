...
class Logger(object):
    ...
    def log_mapping_iteration(self, frame_id, new_pts_num, model_size, iter_opt_time, opt_dict: dict,intrinsic:False) -> None:
        ...
        if self.use_wandb:
            wandb.log({"Mapping/idx": frame_id,
                       ...
                       "Mapping/total_loss": opt_dict[frame_id]["total_loss"]
                       })
            if intrinsic:
                wandb.log({"Mapping/sparsity_loss": opt_dict[frame_id]["sparsity_loss"],
                           "Mapping/shading_smooth_loss": opt_dict[frame_id]["shading_smooth_loss"],
                           "Mapping/prior_chromaticity_loss": opt_dict[frame_id]["prior_chromaticity_loss"],
                           "Mapping/residual_loss": opt_dict[frame_id]["residual_loss"],
                           "Mapping/offset_loss": opt_dict[frame_id]["offset_loss"],
                })
